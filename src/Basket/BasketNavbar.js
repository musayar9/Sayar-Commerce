...
function BasketNavbar() {
  ...
  return (
    <div>
     ...
     onClick={()=>{setIsBasket(isBasket  ? false : true)}}> <span className='flex lg:space-x-2 hover:text-violet-700 duration-500'><span className='hidden lg:block'>Sepetim</span><SlBasketLoaded size={20}/></span> </button>
