        ...
        <div className='p-6 z-20 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 mt-8 cursor-pointer w-98 text-center'>
            <div className='p-6 space-x-8 flex justify-around'>
                <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                    ...
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Zıppın & Body</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Patik</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Bebek Maması</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Bebek Bezi</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Yenidoğan Kıyafet</li>
                ...
                <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                    ...
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Bebek Takımları</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Biberon</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Emzik</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Alıştırma Bardağı</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Termal Mama Çantası</li>
                ...
                <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                    ...
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Bebek Sabunu</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Bebek Çantası</li>
                ...
                <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                    ...
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Yürüteç</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Park Yatak</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Küvet Filesi</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Portbebe</li>
                ...
                <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                    ...
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Oyun Hamuru</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Pluş Oyuncaklar</li>
                    <li className='hover:text-violet-700 duration-500 hover:underline'>Eğitici Oyuncaklar</li>
