...
function SuperMarket() {
  return (
    <div>
    <button className='peer text-gray-700 text-center '  >SuperMarket</button>
      ...
      <div className='p-6 z-20 rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 mt-8 cursor-pointer  text-center'>
          <div className='p-6 space-x-8 flex justify-around'>
              <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                  <h6 className='text-md font-500 text-gray-300 underline'>Kişisel Bakım</h6>
              ...
              <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                  <h6 className='text-md font-500 text-gray-300 underline'>Gıda</h6>
              ...
              <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                  <h6 className='text-md font-500 text-gray-300 underline'>Ev & Temizlik</h6>
          ...
          <div className='p-6 space-x-8 flex justify-around'>
              <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                  <h6 className='text-md font-500 text-gray-300 underline'>Sağlık & Spor</h6>
              ...
              <ul className='space-y-1 text-gray-700 text-md font-[500] mt-2' >
                  <h6 className='text-md font-500 text-gray-300 underline'>PetShop</h6>
