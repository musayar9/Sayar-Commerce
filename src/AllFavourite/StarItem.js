...
function StarItem({star}) {
  ...
  return (
    <>
     ...
     {
       !like ? <button className='z-10 -mt-2 w-8 h-8 md:w-10 md:h-10  top-2 right-2 float-right md:absolute
       ...
       : <button className='z-10 -mt-2 w-8 h-8 md:w-10 md:h-10  top-2 right-2 md:absolute  border border-gray-200  items-center justify-center flex  rounded-full drop-shadow-xl ' onClick={starFavouriteTry}><BsFillSuitHeartFill size={20} className='text-pink-700'/></button>
