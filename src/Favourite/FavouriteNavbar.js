...
function FavouriteNavbar() {
  ...
  return (
   ...
   onClick={()=>{setFavourite(isFavourite  ? false : true)}}> <span className='flex lg:space-x-2 hover:text-violet-700 duration-500'><span className='hidden lg:block'>Favorilerim</span><AiFillLike size={18}/></span> </button>
